...
import {rawdata} from '../redux/Action'
...
class Login extends Component {
      ...
      keyboardVerticalOffset={Platform.OS === "ios" ? 64 : 0}>
        <View style={styles.container1}>
          <View style={{flexDirection: 'row', alignSelf: 'center'}}>
            ...
            <Image style={styles.img} source={require('../asset/neotech.png')} />

          </View>
        </View>

        <View style={{paddingTop: 50}}>
          <Text style={{fontSize: 30, color: 'black', alignSelf: 'center',fontWeight:'bold'}}>
            Login
          </Text>
        </View>
  ...
  >
          ...
          <TouchableOpacity onPress={() => this.submit()}>
            <Text style={{alignSelf:'center',fontWeight:'bold', fontSize:15, color:'blue'}}> Don't Have a Account Sign up?</Text>
          </TouchableOpacity>
        </View>
        </KeyboardAvoidingView>
      </View>
...
const user = <Feather name={'user'} solid style={{fontSize:20}}/>;

const eye = <Feather name={'eye-off'} solid style={{fontSize:20}} />;
