...
class SignUp extends Component{ 
  ...
  >
            ...
            <TouchableOpacity onPress={()=>this.props.navigation.navigate('Login')} >
                    <Text style={{fontWeight:"bold",alignSelf:"center", color:"blue"}}> Already have an Account? Sign up</Text>
                    </TouchableOpacity>
...
const ADDICON = <Icons name={'plus'} solid style={{fontSize:15}} />;
const eyeSlash = <Icons name={'user-plus'} solid style={{fontSize:20}} />;
const user = <Icons name={'user'} solid style={{fontSize:20}} />;
